        ...
        <div className="LoginPage" style={{width: 793, height: 700, left: 373, top: 0, position: 'absolute', background: 'white', borderRadius: 40}}>
          <div className="Signup" style={{width: 269, height: 31, left: 105, top: 457, position: 'absolute'}}>
            <div className="NotAMember" style={{width: 159, height: 30, left: 0, top: 1, position: 'absolute', textAlign: 'center', color: '#C1C1C1', fontSize: 18, fontFamily: 'Poppins', fontWeight: '300', wordWrap: 'break-word'}}>Not a Member?</div>
              ...
              {/* go home */}
              <Link to="/HomePage">
                <div className="Home" style={{width: 90, height: 30, left: 411, top: 0, position: 'absolute', textAlign: 'center', color: '#35CCED', fontSize: 18, fontFamily: 'Poppins', fontWeight: '300', wordWrap: 'break-word'}}>Go Home</div>
              </Link>
          </div>
          {/* id */}
